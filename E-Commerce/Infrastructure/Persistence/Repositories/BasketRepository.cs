...
{
    public class BasketRepository(IConnectionMultiplexer connectionMutiplexer)
        : IBasketRepository
    {
        private readonly StackExchange.Redis.IDatabase _database = connectionMutiplexer.GetDatabase();
